...
#
#     PHX_SERVER=true bin/check_day start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :check_day, CheckDayWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "check.day"

  config :check_day, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
