...
config :check_day, CheckDayWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CheckDayWeb.ErrorHTML, json: CheckDayWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: CheckDay.PubSub,
  live_view: [signing_salt: "nf5xZ/nQ"]
...
config :check_day, CheckDay.Mailer, adapter: Swoosh.Adapters.Local
...
config :hammer,
  backend: {Hammer.Backend.ETS,
            [expiry_ms: 60_000 * 60 * 24, # 24 hours
